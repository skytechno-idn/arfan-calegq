    ...
    <MobileLayout>
      <div>
        ...
        <div className="mt-5 px-3">
          <div className="bg-white shadow-lg flex items-start gap-3 py-2 px-3 rounded-lg relative">
            <div className="absolute -right-1 -top-2">
                <Chip color="success" className="text-white "><span className="font-semibold tracking-tighter">
                Terkirim</span></Chip>
            </div>
            <div>
              <div className="font-semibold">TPS 001</div>
              <div className="text-gray-400 text-sm">
                Buntulia Tengah,Pohuwato
              </div>
              <div className="font-bold">Total DPT : 4.500</div>
            </div>
          </div>
          <div className="mt-3">
        ...
        <Dialog
          ...
          content={
            <>
              Apakah Anda yakin untuk mengonfirmasi suara di TPS ini?
              Selanjutnya, hasil suara akan dikirimkan ke admin untuk divalidasi
              ulang.
            </>
          }
          buttons={
